...
const Header = () => {
  ...
  <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
    ...
    <span className="text-gray-400 cursor-pointer"> 🔍</span>
      ...
      {/* Right corner: Notification, Username */}
...
//   return (
//     <header className="bg-blue-600 dark:bg-blue-900 py-4 px-6 flex flex-col sm:flex-row justify-between items-center">
//       {/* Left corner: Company name */}
...
//       <div className="flex-1 mx-8 flex justify-center relative mt-4 sm:mt-0">
//         <input
//           type="text"
//           placeholder="Search"
//           className="w-full py-2 px-4 pr-12 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500"
